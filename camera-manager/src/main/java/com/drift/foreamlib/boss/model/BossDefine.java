...
public class BossDefine {
	...
	public final static String LOCAL_START_RTSP = "http://%s/cgi-bin/foream_remote_control?start_rtsp=%s";
	public final static String LOCAL_STOP_RTSP = "http://%s/cgi-bin/foream_remote_control?stop_rtsp";
	...
	public final static String LOCAL_SETTING_STREAM_BITRATE = "http://%s/cgi-bin/foream_remote_control?stream_bitrate=%s";
	...
	public final static String LOCAL_RECORD_WITH_PARAM = "http://%s/cgi-bin/foream_remote_control?record_with_param=%s&sec_id=%s";
	public final static String LOCAL_SET_THM = "http://%s/cgi-bin/foream_remote_control?thm=%s";
