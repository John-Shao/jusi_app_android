...
public class LinkFileListActivity2 extends AppCompatActivity {

    private static String TAG = "LinkFileListActivity2";
    ...
    private LinkFileListAdapter2 m_fileListRecycleAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_link_file_list2);
        ...
        rvList = (ListView) findViewById(R.id.rv_list);
                ...
                if(success) {
                    ...
                    try{
                        ...
                        for(int i = 0;i < jsonArray.length();i++){
                            ...
                            if(file.getExtendName().contains("jpg") || file.getExtendName().contains("JPG") )
                                file.setType(HTMLFile.TYPE_PHOTO);
                            else
    ...
    private void initListViewAdapter()
    {
        ...
        m_fileListRecycleAdapter.setOnDownloadClickListener(new LinkFileListAdapter2.OnDownloadClickListener() {
            ...
            public void OnDownloadClickListener(View view, int position) {
                ...
                Toast.makeText(LinkFileListActivity2.this, "下载地址是:" + file.getBigFileUrl(), Toast.LENGTH_SHORT).show();
            }
        });
        m_fileListRecycleAdapter.setOnDeleteClickListener(new LinkFileListAdapter2.OnDeleteClickListener() {
            @Override
...
//                    }
//                });
                Toast.makeText(LinkFileListActivity2.this, "删除操作命令是:" + delCmd, Toast.LENGTH_SHORT).show();
            }
        });
    }
//    private void initRecycleViewAdapter()
//    {
//        LinearLayoutManager layoutManager = new LinearLayoutManager(LinkFileListActivity2.this);
//        rvList.setLayoutManager(layoutManager);
////        rvList.addItemDecoration(new LinkCamListItemDecoration(dip2px(15),dip2px(15)));
//        m_fileListRecycleAdapter = new LinkFileListAdapter(LinkFileListActivity2.this, mList);
